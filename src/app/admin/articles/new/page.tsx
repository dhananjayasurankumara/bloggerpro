        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="p-8 bg-gray-50 dark:bg-zinc-950 border border-gray-100 dark:border-zinc-900 rounded-[40px] space-y-8">
              ...
              <div className="space-y-4">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Tags (comma separated)</label>
                <input 
                  type="text" 
                  placeholder="Wealth, Savings, AI"
                  className="w-full px-4 py-3 bg-white dark:bg-black border border-gray-100 dark:border-zinc-900 rounded-xl text-sm outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-zinc-900 space-y-4">
                <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-500 font-medium">Auto-save:</span>
            ...
            <div className="p-8 bg-primary text-white rounded-[40px] space-y-4 shadow-xl shadow-primary/20 relative overflow-hidden group">
               <div className="absolute -top-10 -right-10 w-32 h-32 bg-white/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700"></div>
               <h4 className="font-display font-bold text-xl relative z-10">AI Writing Assistant</h4>
               <p className="text-white/70 text-sm leading-relaxed relative z-10">Use GPT-4 to generate headlines, summarize your content, or check for SEO optimization.</p>
               <button className="w-full py-3 bg-accent text-primary font-bold rounded-xl text-sm relative z-10 hover:bg-white transition-all">Launch AI Assistant</button>
            </div>
          </div>
        </div>
      </div>
