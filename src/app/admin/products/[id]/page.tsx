...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await axios.get("/api/admin/products"); // Or a specific GET if needed, but admin list works
      ...
      return (
          <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black">
              <div className="flex flex-col items-center gap-4">
                  ...
                  <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Loading Digital Inventory...</span>
              </div>
          </div>
      );
  }
      ...
      <div className="flex justify-between items-end mb-12">
        <div>
           <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-display font-bold">Edit Product</h1>
           </div>
           <p className="text-gray-500">Update configuration for this premium digital asset.</p>
        </div>
        ...
        <button 
            ...
            className="flex items-center gap-2 px-6 py-3 text-red-500 font-bold border border-red-500/20 rounded-xl hover:bg-red-500 hover:text-white transition-all active:scale-95"
        >
